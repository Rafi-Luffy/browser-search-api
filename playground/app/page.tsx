...
const DEFAULT_BASE_URL = "https://crw-production-d1ce.up.railway.app";
...
const endpoints: Endpoint[] = [
  ...
  },
  {
    ...
    bodyKind: "json",
    auth: true,
    description: "Firecrawl-compatible single page scrape.",
  },
  {
    id: "v1-search",
    group: "Search",
    ...
    bodyKind: "json",
    auth: true,
    description: "Native web search endpoint.",
  },
  {
    id: "v2-search",
    group: "Search",
    ...
    bodyKind: "json",
    auth: true,
    description: "Firecrawl-compatible search shape.",
  },
  {
    id: "v1-map",
    group: "Map",
  ...
  },
  {
    ...
    bodyKind: "json",
    auth: true,
    description: "Firecrawl-compatible site mapping.",
  },
  {
    id: "v1-crawl-start",
    group: "Crawl",
  ...
  },
  {
    ...
    bodyKind: "none",
    auth: true,
    description: "Check a v1 crawl job by id.",
  },
  {
    id: "v1-crawl-cancel",
    group: "Crawl",
    ...
    bodyKind: "none",
    auth: true,
    description: "Cancel a v1 crawl job by id.",
  },
  {
    id: "v2-crawl-start",
    group: "Crawl",
    ...
    bodyKind: "json",
    auth: true,
    description: "Start a Firecrawl-compatible crawl job.",
  },
  {
    id: "v2-crawl-active",
    group: "Crawl",
    ...
    bodyKind: "none",
    auth: true,
    description: "List active v2 crawl jobs.",
  },
  {
    id: "v2-batch-scrape",
    group: "Batch",
    label: "v2 Batch Scrape",
    method: "POST",
  ...
  },
  {
    ...
    bodyKind: "multipart",
    auth: true,
    description: "Upload a PDF for text parsing.",
  },
];

const defaultState: PlaygroundState = {
  url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC10985301/",
  formats: ["markdown"],
  query: "OpenAI",
  limit: 3,
  mapUrl: "https://pmc.ncbi.nlm.nih.gov/articles/PMC10985301/",
  crawlUrl: "https://en.wikipedia.org/wiki/Ayurveda",
  maxDepth: 1,
  maxPages: 2,
  crawlId: "",
  batchUrls:
    "https://en.wikipedia.org/wiki/Ayurveda\nhttps://en.wikipedia.org/wiki/Panchakarma",
  previousMarkdown: "# Price\n- Panchakarma: Rs 15000",
  currentMarkdown: "# Price\n- Panchakarma: Rs 18000\n- Consultation: Rs 1000",
  pdfFile: null,
